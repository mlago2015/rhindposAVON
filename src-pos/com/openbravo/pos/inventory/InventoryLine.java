...
public class InventoryLine {
    ...
    private int m_iProdCampania;
    private String m_sProdTalla;
    ...
    public InventoryLine(ProductInfoExt oProduct, TaxInfo tax, double dpor, double dprice, double dstockQty) {
        ...
        m_iProdCampania = oProduct.getCampania();
        m_sProdTalla = oProduct.getTalla();
    ...
    public void setProductCampania(int m_iProdCampania) {
        this.m_iProdCampania = m_iProdCampania;
    }

    public void setProductTalla(String m_sProdTalla) {
        this.m_sProdTalla = m_sProdTalla;
    }
    ...
    public int getProductCampania() {
        return m_iProdCampania;
    }

    public String getProductTalla() {
        return m_sProdTalla;
    }
