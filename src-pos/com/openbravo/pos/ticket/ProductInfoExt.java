...
public class ProductInfoExt {
    ...
    protected int m_iCampania;
    protected String m_sTalla;
    ...
    public final int getCampania() {
        return m_iCampania;
    }

    public final void setCampania(int m_iCampania) {
        this.m_iCampania = m_iCampania;
    }

    public final String getTalla() {
        return m_sTalla;
    }

    public final void setTalla(String m_sTalla) {
        this.m_sTalla = m_sTalla;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            ...
            product.m_iCampania = dr.getInt(4);
            product.m_sTalla = dr.getString(5);
            product.m_sName = dr.getString(6);
            product.m_bCom = dr.getBoolean(7).booleanValue();
            product.m_bScale = dr.getBoolean(8).booleanValue();
            product.m_dPriceBuy = dr.getDouble(9).doubleValue();
            product.m_dPriceSell = dr.getDouble(10).doubleValue();
            product.taxcategoryid = dr.getString(11);
            product.categoryid = dr.getString(12);
            product.attributesetid = dr.getString(13);
            product.m_Image = ImageUtils.readImage(dr.getBytes(14));
            product.attributes = ImageUtils.readProperties(dr.getBytes(15));
            return product;
        }};
    }
