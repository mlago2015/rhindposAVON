...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('4', 'Cajero role', $FILE{/com/openbravo/pos/templates/Role.Cajero.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Administrador', NULL, '0', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Supervisor', NULL, '1', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Empleado', NULL, '2', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Invitado', NULL, '3', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('4', 'Cajero', NULL, '4', 1, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('18', 'billete.100bs', 1, $FILE{/com/openbravo/pos/templates/billete_100bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'billete.50bs', 1, $FILE{/com/openbravo/pos/templates/billete_50bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'billete.20bs', 1, $FILE{/com/openbravo/pos/templates/billete_20bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'billete.10bs', 1, $FILE{/com/openbravo/pos/templates/billete_10bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'billete.5bs', 1, $FILE{/com/openbravo/pos/templates/billete_5bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'billete.2bs', 1, $FILE{/com/openbravo/pos/templates/billete_2bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'moneda.1bs', 1, $FILE{/com/openbravo/pos/templates/moneda_1bs.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'moneda.050bs', 1, $FILE{/com/openbravo/pos/templates/moneda_050bs.png});
...
INSERT INTO CATEGORIES(ID, NAME, CODE) VALUES ('000', 'Categoría Estandar', '0001');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'Sin IVA');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Sin IVA', '000', NULL, NULL, 0, 0, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'IVA', '001', NULL, NULL, 0.12, 0, NULL);
...
CREATE INDEX OFERTAS_INX_1 ON OFERTAS(CAMPANIA);

CREATE TABLE OFERTDET(
    ID VARCHAR(256) NOT NULL,
    ...
    PRIMARY KEY (ID),
    CONSTRAINT OFERTDET_FK_1 FOREIGN KEY (OFERTA) REFERENCES OFERTAS(ID)
);
CREATE INDEX OFERTDET_INX_1 ON OFERTDET(OFERTA);
CREATE INDEX OFERTDET_INX_2 ON OFERTDET(CAMPANIA);
CREATE INDEX OFERTDET_INX_3 ON OFERTDET(REFERENCIA);
...
CREATE TABLE LOCATIONS (
    ...
    NAME VARCHAR(1024) NOT NULL,
    ADDRESS VARCHAR(1024),
    ISCLOSE SMALLINT DEFAULT 0 NOT NULL, 
    PRIMARY KEY (ID)
);
...
CREATE TABLE TICKETSNUM (ID INT GENERATED ALWAYS AS IDENTITY (START WITH 0, INCREMENT BY 1));
INSERT INTO TICKETSNUM VALUES (DEFAULT);
CREATE TABLE TICKETSNUM_REFUND (ID INT GENERATED ALWAYS AS IDENTITY (START WITH 0, INCREMENT BY 1));
INSERT INTO TICKETSNUM_REFUND VALUES (DEFAULT);
CREATE TABLE TICKETSNUM_PAYMENT (ID INT GENERATED ALWAYS AS IDENTITY (START WITH 0, INCREMENT BY 1));
